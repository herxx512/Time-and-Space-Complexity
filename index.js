...
// ANSWER:
'No because a for-loop is being used and it\'s time complexity is O(n).'
...
// ANSWER:
'No. The space complexity is dependent on the input size array, giving it O(n).'
...
// ANSWER: 
'Each function is displaying a linear space complexity. Therefore both have a space complexity of O(n).'
